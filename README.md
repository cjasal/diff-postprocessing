...
Their format is detailed in the [tidySnake documentation](https://github.com/MataiMRI/tidySnake#formats).
...
**Important:** This workflow first runs the [tidySnake](https://github.com/MataiMRI/tidySnake) workflow to generate quality control related files. You need to edit the QC status files to indicate which sessions are good and **rerun** the workflow to process these.
